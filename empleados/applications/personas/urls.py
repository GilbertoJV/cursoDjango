...
urlpatterns = [
    ...
    path('api/listByArea/<short_name>', views.ListByAreaEmpleado.as_view(), name='empleados_area'),
    path('api/listAdmin', views.ListEmpleadosAdmin.as_view(), name='empleados_admin'),
